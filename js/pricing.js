$(".price-btn2").click(function(){
    document.getElementById("silverprz").textContent = "Rs 7,000"
    document.getElementById("goldprz").textContent = "Rs 20,000"
    document.getElementById("premiumprz").textContent = "Rs 30,000"
...
$(".price-btn1").click(function(){
    document.getElementById("silverprz").textContent = "Rs 9,800"
    document.getElementById("goldprz").textContent = "Rs 28,000"
    document.getElementById("premiumprz").textContent = "Rs 42,000"
    $('.price-btn2').css({
        border: 'none',
        backgroundColor: 'transparent',
        color: '#09203e',
