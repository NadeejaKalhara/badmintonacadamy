(function($) {
    $.fn.weekly_schedule = function(callerSettings) {
        ...
        function parseHours(string) {
            ...
            var startMinute = parseInt(split[0].split(":")[1]);
            var endInt = parseInt(split[1].split(":")[0]);
            var endMinute = parseInt(split[1].split(":")[1]);
            ...
            var curMinute = startMinute;
        
            while (curHour < endHour || (curHour === endHour && curMinute <= endMinute)) {
                var parsedStr = "";
        
                if (curHour > 12) {
                    parsedStr += (curHour - 12).toString();
                } else if (curHour === 12) {
                    parsedStr += curHour.toString();
                } else {
                    parsedStr += curHour.toString();
                }
