(function($) {
    $.fn.weekly_schedule = function(callerSettings) {
        ...
        var settings = $.extend({
            ...
            fontSize: "1.1em", // Font size used in the component
            hoverColor: "#727bad", // Background color when hovered
            selectionColor: "#ffab00", // Background color when selected
        ...
        // options is an object, initialize!
            ...
            for(var i = 0; i < days.length; i++) {
                ...
                for(var j = 0; j < hours.length; j++) {
                    var hour = $('<div></div>', {
                        class: `c${i} hour ` + hours[j] + " borderradius bg-label-primary",
                        onmouseup:`myclick(this)`,
